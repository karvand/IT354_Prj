				...
				if (xmlhttp.status == 200) {
					...
					if (movieInfo.total != 0) {
						...
						for (i = 0; i < movieInfo.movies.length; i++) {
							...
							element.innerHTML = element.innerHTML + "<br/>" + "<img src=" + movieInfo.movies[i].posters.thumbnail + ">" + "<h3>" + movieInfo.movies[i].title + "(" + movieInfo.movies[i].year + ")" + "</h3>" + "<b>Rating: </b>" + movieInfo.movies[i].mpaa_rating + "<br/>" + "<b>Runtime: </b>" + movieInfo.movies[i].runtime + " min<br/>" + "<b>Release Dates: </b><ul><li><b>In Theaters: </b>" + movieInfo.movies[i].release_dates.theater + "</li><li><b>On DVD: </b>" + movieInfo.movies[i].release_dates.dvd + "</li></ul>" + "<b>Critics Rating: </b>" + movieInfo.movies[i].ratings.critics_rating + "<br/>" + "<b>Critics Score: </b>" + movieInfo.movies[i].ratings.critics_score + "<br/>" + "<b>Audience Rating: </b>" + movieInfo.movies[i].ratings.audience_rating + "<br/>" + "<b>Audience Score: </b>" + movieInfo.movies[i].ratings.audience_score + "<br/>" + "<b>Summary: </b>" + movieInfo.movies[i].synopsis + "<br/>" + "<b>Cast: </b>" + cast + "<br/><br/>" + "<a onclick='getReviews(/" + movieInfo.movies[i].id + "/,/" + movieInfo.movies[i].title + "/)' href='#'><b>Reviews</b></a>" + "<br/><br/><hr>";
						}
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4) {
			if (xmlhttp.status == 200) {
				...
				if (movieInfo.movies.length != 0) {
					for (i = 0; i < movieInfo.movies.length; i++) {
						element.innerHTML += "<a onclick='getMovieDetailsFromImages(\"" + movieInfo.movies[i].id + "\")' href='#'><img id='image' src = " + movieInfo.movies[i].posters.thumbnail + "></a>";
					}
				} else alert("Error -> xmlhttp status: " + xmlhttp.status);
			}
		}
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4) {
			if (xmlhttp.status == 200) {
				...
				element.innerHTML = element.innerHTML + "<br/>" + "<img src=" + movieInfo.posters.thumbnail + ">" + "<h3>" + movieInfo.title + "(" + movieInfo.year + ")" + "</h3>" + "<b>Genre(s): </b>" + genre + "<br/>" + "<b>Rating: </b>" + movieInfo.mpaa_rating + "<br/>" + "<b>Runtime: </b>" + movieInfo.runtime + " min<br/>" + "<b>In Theaters: </b>" + movieInfo.release_dates.theater + "<br/>" + "<b>Critics Rating: </b>" + movieInfo.ratings.critics_rating + "<br/>" + "<b>Critics Score: </b>" + movieInfo.ratings.critics_score + "<br/>" + "<b>Audience Rating: </b>" + movieInfo.ratings.audience_rating + "<br/>" + "<b>Audience Score: </b>" + movieInfo.ratings.audience_score + "<br/>" + "<b>Summary: </b>" + movieInfo.synopsis + "<br/>" + "<b>Cast: </b>" + cast + "<br/>" + "<b>Director(s): </b>" + director + "<br/>" + "<b>Studio: </b>" + movieInfo.studio + "<br/><br/>" + "<a onclick='getReviews(/" + movieInfo.id + "/,/" + movieInfo.title + "/)' href='#'><b>Reviews</b></a><br/>";
			} else alert("Error -> xmlhttp status: " + xmlhttp.status);
		}
	};
}
